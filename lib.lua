...
local Utility = {}
local Objects = {}
function giigii:DraggingEnabled(frame, parent)
...
function giigii.CreateLib(kavName, themeList)
    ...
    giigii:DraggingEnabled(MainHeader, Main)
    ...
    function giigii:ChangeColor(prope,color)
